...
int main() {
  ...
  //std::shared_ptr<Device> device2 = std::make_shared<CyclicDevice>("Lavatrice", -2.0, cycle(1,50));
  //std::shared_ptr<Device> device3 = std::make_shared<CyclicDevice>("Lavastoviglie", -1.5, cycle(3,15));
  std::shared_ptr<Device> device4 = std::make_shared<ManualDevice>("Pompa di calore + termostato", -2.0);
  //std::shared_ptr<Device> device5 = std::make_shared<CyclicDevice>("Tapparelle elettriche", -0.3, cycle(1,0));
  ...
  //std::shared_ptr<Device> device8 = std::make_shared<CyclicDevice>("Forno a microonde", -0.8, cycle(0,2));
  //std::shared_ptr<Device> device9 = std::make_shared<CyclicDevice>("Asciugatrice", -0.5, cycle(1,0));
  //std::shared_ptr<Device> device10 = std::make_shared<CyclicDevice>("Televisore", -0.2, cycle(1,0));
