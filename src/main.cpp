...
int main() {
  ...
  std::shared_ptr<Device> device7 = std::make_shared<ManualDevice>("Frigorifero", -1.4);
  ...
  // Privileged device that stays on until there are no other devices to turn off (power policy)
  device7->plugDevice();
